...
const DownloadIcon: FC<IconProps> = ({ svgProps = { className: "dark:fill-app-white fill-black dark:hover:fill-app-yellow hover:fill-app-yellow transition-all duration-[150]" }, color }) => {
    return (
